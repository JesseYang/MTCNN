...
def predict_image_multi_scale(input_image, p_predict_func, r_predict_func, o_predict_func):
...
def predict_on_video(video_path, p_predict_func, r_predict_func, o_predict_func):
...
if __name__ == '__main__':
    ...
    if args.multi_scale:
        ...
        predict_on_video(args.video_path, p_predict_func, r_predict_func, o_predict_func)
